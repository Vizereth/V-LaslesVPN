...
***************************************************************************** */
function ae(e,t,s,i){return new(s||(s=Promise))((function(n,r){function a(e){try{o(i.next(e))}catch(e){r(e)}}function l(e){try{o(i.throw(e))}catch(e){r(e)}}function o(e){e.done?n(e.value):function(e){return e instanceof s?e:new s((function(t){t(e)}))}(e.value).then(a,l)}o((i=i.apply(e,t||[])).next())}))}window.addEventListener("load",(function(e){re()}));function le(e,t={}){return ae(this,void 0,void 0,(function*(){if(!(e instanceof Element||e instanceof Window))throw new Error(`element passed to scrollTo() must be either the window or a DOM element, you passed ${e}!`);t=de(t);const s=(t,i,n,r,a=300,l,o)=>{window.requestAnimationFrame((()=>{const d=Date.now(),c=Math.min(1,(d-r)/a);if(t===i)return o?o():null;!function(e,t){const s=ce.getDocument();e===s.body||e===s.documentElement||e instanceof Window?(s.body.scrollTop=t,s.documentElement.scrollTop=t):e.scrollTop=t}(e,l(c)*(i-t)+t),c<1?s(t,i,n,r,a,l,o):o&&o()}))},i=function(e){const t=ce.getDocument();return e===t.body||e===t.documentElement||e instanceof Window?t.body.scrollTop||t.documentElement.scrollTop:e.scrollTop}(e),n=function(e){const t={window:{y:"scrollY",x:"scrollX"},element:{y:"scrollTop",x:"scrollLeft"}},s="y";return e instanceof Window?t.window[s]:t.element[s]}(e);return new Promise((e=>{s(i,"number"==typeof t.top?t.top:i,n,Date.now(),t.duration,ue(t.easing),e)}))}))}function oe(e,t,s){!function(e){if(void 0===e){throw new Error("The element passed to scrollIntoView() was undefined.")}if(!(e instanceof HTMLElement))throw new Error(`The element passed to scrollIntoView() must be a valid element. You passed ${e}.`)}(e),!t||t instanceof Element||(s=t,t=void 0);const{duration:i,easing:n}=de(s);t=t||ce.getDocument().body;let r=0,a=e?e.offsetTop:0;const l=ce.getDocument();return t!==l.body&&t!==l.documentElement||(r=window.pageYOffset,a=e.getBoundingClientRect().top+r),le(t,{top:a,left:0,duration:i,easing:n})}function de(e={}){return"smooth"===e.behavior&&(e.easing="ease-in-out",e.duration=300),"auto"===e.behavior&&(e.duration=0,e.easing="linear"),e}const ce={getDocument:()=>document},pe={linear:e=>e,"ease-in":e=>e*e,"ease-out":e=>e*(2-e),"ease-in-out":e=>e<.5?2*e*e:(4-2*e)*e-1},ue=e=>{const t=pe[e||"linear"];if(!t){const t=Object.keys(pe).join(",");throw new Error(`Scroll error: scroller does not support an easing option of "${e}". Supported options are ${t}`)}return t};(()=>{const e={1:{link:document.querySelector(".menu__link--about"),linkMobile:document.querySelector(".mobile-menu__link--about"),scrollsTo:document.querySelector(".start")},2:{link:document.querySelector(".menu__link--features"),linkMobile:document.querySelector(".mobile-menu__link--features"),scrollsTo:document.querySelector(".features")},3:{link:document.querySelector(".menu__link--pricing"),linkMobile:document.querySelector(".mobile-menu__link--pricing"),scrollsTo:document.querySelector(".plan")},4:{link:document.querySelector(".menu__link--testimonials"),linkMobile:document.querySelector(".mobile-menu__link--testimonials"),scrollsTo:document.querySelector(".reviews")},5:{link:document.querySelector(".menu__link--help"),linkMobile:document.querySelector(".mobile-menu__link--help"),scrollsTo:document.querySelector(".footer")}};for(const t in e){const s=e[t].link,i=e[t].linkMobile,n=e[t].scrollsTo;s&&s.addEventListener("click",(()=>{oe(n,document.body,{behavior:"smooth"})})),i&&i.addEventListener("click",(()=>{oe(n,document.body,{behavior:"smooth"})}))}})();window.FLS=!0,function(e){let t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}((function(e){let t=!0===e?"webp":"no-webp";document.documentElement.classList.add(t)}))})();